...
export class Annotation extends React.Component {
  ...
  render(){
    ...
    for (var j=0; j < this.props.keypoints.length / 3; j++){
      ...
      let keypoint_name = this.props.category[0].keypoints_name[j];
      let keypoint_color = this.props.category[0].keypoints_style[j];
      ...
      <div className="card">
        <div className="card-header"
          ...
          <div className="d-flex justify-content-between">
            <div className="p-2" data-toggle="collapse" style={{cursor : "pointer"}} data-parent="#annotationAccordion"
              href={"#annotationBody" + this.props.id} category={{cursor : "pointer"}}>
              {/*<span className="badge px-2 mr-1" category={{backgroundColor: annotation_color}}></span>*/}
            ...
            {/*<div className="p-2">*/}
              {/*<div className="btn-group" role="group">*/}
                {/*<button type="button" className="btn btn-sm btn-outline-secondary" disabled onClick={this.onFocus}>Focus</button>*/}
                {/*<button type="button" className="btn btn-sm btn-outline-secondary" disabled onClick={this.onAnnotateNA}>Annotate N/A</button>*/}
                {/*<button type="button" className="btn btn-sm btn-outline-secondary" disabled onClick={this.onHideOthers}>Hide Others</button>*/}
              {/*</div>*/}
            {/*</div>*/}
            <div className="p-2">
              {hiddenBadge}
        ...
        {/* all keypoints radio btn*/}
        <div className="collapse show" role="tabpanel" id={"annotationBody" + this.props.id}>
